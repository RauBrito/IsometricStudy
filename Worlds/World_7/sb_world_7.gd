...
@onready var MOVE_TILE = preload("uid://bwmk1wuctbt7g")
...
func _ready():
	...
	print(position)
	print(floor_1.get_available_surrounding_cells(cell_pos,2))
	pass
...
func show_move(cell:Vector2i,amount:int):
	...
	var surr_cells = floor_1.get_available_surrounding_cells(cell,1)
	create_tile(cell)
